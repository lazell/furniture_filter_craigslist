...
def generate_filtered_dfs(filename, max_value=1200):
    ...
    df = df[['Image', 'Title', 'Price', 'Time', 'Section', 'URL']]
...
def export_df_to_html(df, title, htmlid):
    ...
    print htmlname + " created in current directory"
...
if __name__ == '__main__':
    ...
    export_df_to_html(df1,"List 1: Manufacturer, Designer, Style Filtered List","List_1")
